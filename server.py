...
def build_realtime_instructions(request_body):
    ...
    return (
        ...
        f"AGENT BRIEFING:\n{profile_briefing}\n\n"
        "Even though the user is signed in to MyHealth, perform a quick voice-channel verification before preparing the action packet. "
        "Acknowledge the sign-in, then ask for the caller's name and date of birth: "
        "'I see you're signed in to MyHealth - just to verify on this channel, can you confirm your name and date of birth?' "
